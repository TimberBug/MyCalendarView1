...
//    protected Paint mTitleBGPaint;
    ...
    protected Paint mSelectedEndDayBgPaint;
    protected Paint mCurrentDayBgPaint;
...
//    protected int mDayTextColor;
    ...
    protected int mSelectedDaysBgColor;                 // 选中的入住日期背景颜色
    protected int mSelectedEndDaysBgColor;                 // 选中的离店日期背景颜色
    protected int mCurrentDaysBgColor;                 // 当天日期背景颜色
...
//        mDayTextColor = typedArray.getColor(R.styleable.DayPickerView_colorDayName, resources.getColor(R.color.normal_day));
        ...
        mSelectedEndDaysBgColor = typedArray.getColor(R.styleable.DayPickerView_colorSelectedEndDayBackground, resources.getColor(R.color.selected_end_day_background));
        mCurrentDaysBgColor = typedArray.getColor(R.styleable.DayPickerView_currentDayBackground, resources.getColor(R.color.current_day_background));
...
//        mDrawRect = typedArray.getBoolean(R.styleable.DayPickerView_drawRoundRect, true);
    ...
    private void drawMonthDayLabels(Canvas canvas) {
        ...
        for (int i = 0; i < mNumDays; i++) {
            ...
            canvas.drawText((mDateFormatSymbols.getShortWeekdays()[mDayLabelCalendar.get(Calendar.DAY_OF_WEEK)].toUpperCase(Locale.getDefault()).substring(1)),
                    x, y, mWeekTextPaint);
        }
    }
    ...
    protected void drawMonthCell(Canvas canvas) {
        ...
        while (day <= mNumCells) {
            ...
            if (mHasToday && (mToday == day)) {
                ...
                drawDayBg(canvas, x, y, mCurrentDayBgPaint);
            }
            // 已过去的日期
            ...
            if (mStartDate != null && cellCalendar.equals(mStartDate) && !mStartDate.equals(mEndDate)) {
                ...
                canvas.drawText("入住", x, getTextYCenter(mDayTextPaint, y + DAY_SELECTED_RECT_SIZE), mSelectedDayBgPaint);
                /*if(isToady) {
            ...
            if (mEndDate != null && cellCalendar.equals(mEndDate) && !mStartDate.equals(mEndDate)) {
                isLastDay = true;
                drawDayBg(canvas, x, y, mSelectedEndDayBgPaint);
                mDayTextPaint.setColor(mSelectedDayTextColor);
                canvas.drawText("离店", x, getTextYCenter(mDayTextPaint, y + DAY_SELECTED_RECT_SIZE), mSelectedEndDayBgPaint);
            }
                ...
                if (cellCalendar.equals(calendarDay) && !isPrevDay) {
                    ...
                    if (mStartDate != null && mEndDate != null && mNearestDay != null &&
                        ...
                        if (mStartDate != null && mEndDate == null && mNearestDay != null && cellCalendar.equals(mNearestDay)) {
                            ...
                            canvas.drawText("满房", x, getTextYCenter(mBusyDayBgPaint, y + DAY_SELECTED_RECT_SIZE), mBusyDayBgPaint);
                        }
                    }
...
//                        drawDayBg(canvas, x, y, mInValidDayBgPaint);
                            ...
                            canvas.drawText("禁用", x, getTextYCenter(mInValidDayBgPaint, y + DAY_SELECTED_RECT_SIZE), mDayTextPaint);
                        }
                    }
...
//        mYearMonthPaint.setFakeBoldText(true);
        ...
        mYearMonthPaint.setTypeface(Typeface.create(mMonthTitleTypeface, Typeface.NORMAL));
...
//        mTitleBGPaint.setStyle(Style.FILL);
        ...
        // 当天日期背景paint
        mCurrentDayBgPaint = new Paint();
        mCurrentDayBgPaint.setFakeBoldText(true);
        mCurrentDayBgPaint.setAntiAlias(true);
        mCurrentDayBgPaint.setColor(mCurrentDaysBgColor);
        mCurrentDayBgPaint.setTextAlign(Align.CENTER);
        mCurrentDayBgPaint.setStyle(Style.FILL);
        mCurrentDayBgPaint.setAlpha(SELECTED_CIRCLE_ALPHA);
        ...
        // 被选中的离店日期背景paint
        mSelectedEndDayBgPaint = new Paint();
...
//        }
    ...
    private void drawDayBg(Canvas canvas, int x, int y, Paint paint) {
        RectF rectF = new RectF(x - DAY_SELECTED_RECT_SIZE, y - DAY_SELECTED_RECT_SIZE*2 + MINI_DAY_NUMBER_TEXT_SIZE/3,
                x + DAY_SELECTED_RECT_SIZE, y + DAY_SELECTED_RECT_SIZE/2 - MINI_DAY_NUMBER_TEXT_SIZE/6);
